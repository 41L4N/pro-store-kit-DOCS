...
/**
 * Dev-only: Vite exige la barra final con `base` cuando visitas sin ella.
 * El middleware va al frente de la pila para ejecutarse antes de la comprobación interna de Vite.
 */
